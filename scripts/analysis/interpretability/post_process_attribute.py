...
# ----- 配置 -----
R2_MATRIX_FILE = r"results/transfer_results/aef/transfer_matrix_r2.csv"
EMB_DIST_FILE = r"results/transfer_results/aef/transfer_embedding_distances_gnn.csv"  # 由 run_single_transfer 生成
OUTPUT_PREFIX = "results/legacy_analysis/attribute/attribution"
