...
# ========================== 用户配置 ==========================
CDS_MATRIX_FILE = r"CDS_matrix.csv"          # 您的 CDS 矩阵文件
DIST_FILE = r"transfer_results_log\transfer_embedding_distances_gnn.csv"
CITY_STATS_FILE = "city_population_stats.csv"  # 可选，若存在则进行多变量控制
OUTPUT_PREFIX = "results\\regression\\domain_shift_analysis\\quantify_result_CDS"
