...
# 文件路径
R2_MATRIX_FILE = r"results/transfer_results/aef\transfer_matrix_r2_gnn.csv"
DIST_FILE = r"results/transfer_results/aef\transfer_embedding_distances_gnn.csv"
...
# 保存结果
df_results.to_csv('results\\legacy_analysis\\attribute\\distance_correlation_results.csv', index=False)
