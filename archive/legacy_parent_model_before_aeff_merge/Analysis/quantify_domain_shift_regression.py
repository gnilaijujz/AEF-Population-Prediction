...
# ---------- 配置 ----------
R2_MATRIX_FILE = r"results/legacy_analysis/mlp_transfer_results_1\transfer_matrix_r2_mlp.csv"
DIST_FILE = r"results/legacy_analysis/mlp_transfer_results_1\transfer_embedding_distances_mlp.csv"
CITY_STATS_FILE = "city_population_stats.csv"  # 可选
OUTPUT_PREFIX = "results/legacy_analysis/mlp_transfer_results_1/regression_quantify"
