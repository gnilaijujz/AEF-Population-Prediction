...
# 相对脚本/仓库根定位:任意机器 clone 后无需改路径(仍可用 --aef-root/--pop-csv/--out-dir 覆盖)
SCRIPT_DIR = Path(__file__).resolve().parent
REPO_ROOT = SCRIPT_DIR.parents[1]                      # .../model/GNN -> 仓库根
DEFAULT_AEF_ROOT = REPO_ROOT / "data_AEF"
DEFAULT_POP_CSV = REPO_ROOT / "MSA" / "raw_msa_data" / "ACSDT5Y2020.pop" / "ACSDT5Y2020.B01003-Data.csv"  # 人口标签;不在仓库内时用 --pop-csv 指定
DEFAULT_SHP = None
DEFAULT_OUT_DIR = SCRIPT_DIR / "selftrain"             # 自训练模型/预测输出
