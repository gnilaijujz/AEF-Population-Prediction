...
REPO_ROOT = SCRIPT_DIR.parents[1]                      # .../model/GNN -> 仓库根
...
DEFAULT_PRETRAINED_DIR = SCRIPT_DIR / "selftrain"      # 与 GNN_regression 的 --out-dir 一致
DEFAULT_OUT_DIR = SCRIPT_DIR / "transfer_results_log"
