...
DEFAULT_AEF_ROOT = Path(r"G:\AEFf\data_AEF_clean_shp")
DEFAULT_POP_CSV = Path(r"assets/ACSDT5Y2020.pop/ACSDT5Y2020.B01003-Data.csv")
DEFAULT_PRETRAINED_DIR = Path("GNN_output\output_try_log_clean")
DEFAULT_OUT_DIR = Path("GNN_ouput/transfer_results_experiments_clean")
        ...
        for src, src_bundle in source_bundles.items():
            ...
            for tgt in target_cities:
                ...
                embed_dist_list.append({
                    ...
                    "L1_Dist": l1_dist,
                    "L2_Dist": l2_dist,
                    "Cos_Sim": cos_sim,      # 相似度，越高越好
                    "MMD": dist,          # 距离，越低越好
                    #"CKA_Sim": cka_sim       # 相似度，越高越好
                })
                # ---- 准备预测数据（可能打乱） ----
