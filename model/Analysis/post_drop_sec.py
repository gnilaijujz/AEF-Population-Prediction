...
MODES = {
    "null": r"GNN_output/transfer_results_experiments/transfer_matrix_r2_null_calibrated.csv",   # 零模型
    "gnn": r"GNN_output/transfer_results_experiments/transfer_matrix_r2_gnn_calibrated.csv"      # 真实迁移（如果有）
}
EMBEDDING_DIST_FILE = r"GNN_output/transfer_results_experiments/transfer_embedding_distances_gnn.csv"  # 嵌入距离文件（由主脚本生成）
