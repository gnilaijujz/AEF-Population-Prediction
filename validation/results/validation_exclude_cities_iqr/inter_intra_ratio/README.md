# validation/results/validation_exclude_cities_iqr/inter_intra_ratio
...
- Subdirectories: 0
- Files: 3
- Key files: `prediction_results.csv`, `regression_summary.txt`, `validation_plot_inter_intra_ratio.png`
