# validation/results/validation_exclude_cities_iqr/embedding_diversity
...
- Subdirectories: 0
- Files: 3
- Key files: `prediction_results.csv`, `regression_summary.txt`, `validation_plot_embedding_diversity.png`
