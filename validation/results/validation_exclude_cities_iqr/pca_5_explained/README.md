# validation/results/validation_exclude_cities_iqr/pca_5_explained
...
- Subdirectories: 0
- Files: 3
- Key files: `prediction_results.csv`, `regression_summary.txt`, `validation_plot_pca_5_explained.png`
